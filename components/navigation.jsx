            ...
            <nav className=" w-full ">
                <div className="w-full">
                    <div className="w-full h-auto flex items-center py-6">
                        <div className="flex justify-between px-4 md:px-20 w-full ">
                            {/* The logo */}
                            <div className=" flex justify-center items-center flex-shrink-0">
                                {/* <Image src={logo} className="w-16 rounded-full "/> */}
                                <div className="text-base md:text-2xl tracking-wide uppercase font-bold font-sans">Shop Name</div>
                            </div>
                            {/* navigation links */}
                            <div className="hidden md:block ">
                                <div className="ml-10 flex justify-between w-full space-x-6  items-center tracking-wider ">
                                    ...
                                    {/* <Image></Image> */}
                                    <div className="px-4 md:px-10 hover:color-amber-700 duration-700 ease-in">
